  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 p-6">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {/* Help link to dedicated imports page */}
        <div>
          <Link href="/imports">
            <Card className="border-emerald-200 dark:border-emerald-900 bg-emerald-50/30 dark:bg-emerald-950/20 hover:border-emerald-400 cursor-pointer transition-colors" data-testid="link-imports-page">
              <CardContent className="pt-4 pb-4 flex items-center gap-3">
                <FileSpreadsheet className="w-5 h-5 text-emerald-600 flex-shrink-0" />
                <div className="flex-1">
                  <p className="text-sm font-medium text-zinc-900 dark:text-white">Vous avez un relevé bancaire (CSV / Excel / TXT) ?</p>
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">Utilisez la page Import dédiée pour importer plusieurs lignes en une fois.</p>
                </div>
