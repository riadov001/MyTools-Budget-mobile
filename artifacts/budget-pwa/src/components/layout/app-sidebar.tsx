  ...
  const groups: NavGroup[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Encaissements", titleEn: "Receipts", url: "/payments?direction=inbound", icon: CreditCard,
          description: "Paiements reçus de vos clients (espèces, virements, cartes).",
          descriptionEn: "Payments received from clients (cash, transfer, card)." },
    ...
    },
    {
      ...
      labelEn: "Internal Operations",
      collapsible: true,
      items: [
        { title: "Journal des écritures", titleEn: "Journal Entries", url: "/journal", icon: List,
          description: "Toutes les écritures comptables chronologiques (sans tiers externe).",
          descriptionEn: "All accounting entries in chronological order (no external counterparty)." },
        { title: "Plan comptable", titleEn: "Chart of Accounts", url: "/accounts", icon: List,
          description: "Structure interne des comptes selon le PCG (FR/MA).",
          descriptionEn: "Internal chart of accounts following PCG (FR/MA)." },
        { title: "URSSAF & Impôts", titleEn: "URSSAF & Taxes", url: "/urssaf", icon: Calculator,
          description: "Charges sociales et déclarations fiscales (obligations internes).",
          descriptionEn: "Social charges and tax filings (internal obligations)." },
        { title: "Abonnements SaaS", titleEn: "SaaS Subscriptions", url: "/services", icon: Wallet,
          description: "Vos abonnements logiciels récurrents (dépenses internes).",
          descriptionEn: "Your recurring software subscriptions (internal expenses)." },
      ],
    },
    {
      label: "Opérations fournisseurs",
      labelEn: "Supplier Operations",
      collapsible: true,
      items: [
    ...
    },
    {
      ...
      collapsible: true,
      items: [
        { title: "Paiements & lettrage", titleEn: "Payments & Matching", url: "/payments", icon: CreditCard,
          description: "Vue unifiée des encaissements/décaissements + lettrage automatique.",
          descriptionEn: "Unified view of in/out flows + automatic matching." },
    ...
    },
    {
      ...
      items: [
        { title: "Module Comptabilité", titleEn: "Accounting Module", url: "/accounting", icon: BookOpen,
          description: "Bilan, compte de résultat et partie double (niveau pro).",
          descriptionEn: "Balance sheet, P&L and double-entry (pro grade).",
          isNew: true },
      ],
    },
    {
